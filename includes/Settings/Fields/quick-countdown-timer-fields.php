		...
		'advanced' => array(
			'advanced_styles'  => array(
				'settings_list' => array(
					// Segment Width.
					'segment_width'     => array(
						'input_label' => esc_html__( 'Segment width', 'gpls-wpsctr-simple-countdown-timer' ),
						'type'        => 'number',
						'value'       => 0,
						'classes'     => $plugin_info['classes_prefix'] . '-segment-width',
						'attrs'       => array(
							'min' => 0,
						),
					),
					// Segment Height.
					'segment_height'     => array(
						'input_label' => esc_html__( 'Segment height', 'gpls-wpsctr-simple-countdown-timer' ),
						'type'        => 'number',
						'value'       => 0,
						'classes'     => $plugin_info['classes_prefix'] . '-segment-height',
						'attrs'       => array(
							'min' => 0,
						),
					),
					// Segment Fontsize.
					'segment_fontsize'     => array(
						'input_label' => esc_html__( 'Segment fontsize', 'gpls-wpsctr-simple-countdown-timer' ),
						'type'        => 'number',
						'value'       => 0,
						'classes'     => $plugin_info['classes_prefix'] . '-segment-fontsize',
						'attrs'       => array(
							'min' => 0,
						),
					),
					...
					'titles_fontsize'     => array(
						'input_label' => esc_html__( 'Titles fontsize', 'gpls-wpsctr-simple-countdown-timer' ),
						'type'        => 'number',
						'value'       => 0,
						'classes'     => $plugin_info['classes_prefix'] . '-titles-fontsize',
						'attrs'       => array(
							'min' => 0,
						),
					),
