...
<div class="timer-configurations-metabox">
	<div class="colors-wrapper col-12 my-2 p-3 bg-white shadow-sm">
		...
		<h5><?php printf( esc_html__( 'Timer Interval', 'simple-countdown' ) ); ?></h5>
		<?php $cpt->settings->print_fields( 'general', 'interval' ); ?>
		<!-- Countdown Timer -->
		<h5 class="mt-3"><?php printf( esc_html__( 'CountDown Timer', 'simple-countdown' ) ); ?></h5>
				...
				<div class="col">
					<div class="settings-list row">
						<div class="tab-section-wrapper col-12 my-3 p-3 bg-white shadow-lg">
							<!-- Advanced Styles -->
							<div class="countdown-timer-advanced-styles my-3">
								<h5 class="mt-3 mb-2"><?php esc_html_e( 'Advanced styles', 'gpls-wpsctr-simple-countdown-timer' ); ?>
									<span><?php $core->new_keyword( 'New', false ); ?><?php $core->pro_btn(); ?></span>
								</h5>
								<span><?php esc_html_e( 'These styles work per shortcode', 'gpls-wpsctr-simple-countdown-timer' ); ?></span>
								<div class="advanced-styles-list bg-light opacity-50">
									<?php $cpt->settings->print_fields( 'general', 'advanced_styles' ); ?>
								</div>
							</div>
							<!-- CountDowm Timer -->
		...
		<!-- Timer Colors -->
		<h5 class="mt-3"><span class="me-3"><?php printf( esc_html__( 'Timer Colors', 'simple-countdown' ) ); ?></span><?php $core->pro_btn(); ?></h5>
		<div class="container-fluid">
			<div class="row">
				<div class="col">
					<div class="settings-list row">
