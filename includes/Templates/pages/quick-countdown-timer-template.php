...
<!-- Advanced Styles -->
<div class="countdown-timer-advanced-styles">
	...
	<span><?php esc_html_e( 'These styles work per shortcode, you will need to set it as attributes for each shortcode.', 'gpls-wpsctr-simple-countdown-timer' ); ?></span>
	<div class="advanced-styles-wrapper opacity-50 bg-white">
		<?php $template_page->settings->print_fields( 'advanced' ); ?>
	</div>
</div>
